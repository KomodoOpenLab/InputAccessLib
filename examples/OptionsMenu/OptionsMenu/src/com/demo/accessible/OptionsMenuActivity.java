...
public class OptionsMenuActivity extends Activity {
    ...
    public boolean onCreateOptionsMenu(Menu menu){
    	...
    	menu.addSubMenu(1, 0, 0, menu_items[1]);
    	menu.addSubMenu(1, 0, 0, menu_items[2]).setIcon(android.R.drawable.ic_input_add);
    	menu.addSubMenu(1, 0, 0, menu_items[3]).setIcon(android.R.drawable.arrow_up_float);
    	menu.addSubMenu(1, 0, 0, menu_items[4]).setIcon(android.R.drawable.ic_menu_help);
    	return true;
    }
